...
class CandidateTest(unittest.TestCase):
    ...
    def test_candidate(self):
        ...
        bodyText = driver.find_element_by_css_selector("BODY").text
        print bodyText
        self.assertFalse("Testkasutaja Kasutaja" in bodyText)
        #self.assertNotEqual("Testkasutaja Kasutaja", driver.find_element_by_xpath("//table[@id='searchTextResults']/tbody/tr[3]/td[2]").text)
